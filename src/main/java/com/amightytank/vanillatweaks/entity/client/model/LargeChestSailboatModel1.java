...
public class large_boat<T extends Entity> extends EntityModel<T> {
	...
	public large_boat(ModelPart root) {
		...
		this.chest_lid = this.visual_root.getChild("chest_lid");
		this.chest_knob = this.visual_root.getChild("chest_knob");
		this.chest_base = this.visual_root.getChild("chest_base");
