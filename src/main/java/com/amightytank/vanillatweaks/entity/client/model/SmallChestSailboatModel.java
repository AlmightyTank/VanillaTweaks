...
public class SmallChestSailboatModel extends ListModel<Boat> implements WaterPatchModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition chest_lid = visual_root.addOrReplaceChild("chest_lid", CubeListBuilder.create().texOffs(8, 55).addBox(0.0F, 0.0F, 0.0F, 12.0F, 5.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, -15.0F, 14.0F, 0.0F, 3.1416F, 0.0F));

        PartDefinition chest_knob = visual_root.addOrReplaceChild("chest_knob", CubeListBuilder.create().texOffs(62, 0).addBox(0.0F, 0.0F, 0.0F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -12.0F, 2.0F, 0.0F, 3.1416F, 0.0F));

        PartDefinition chest_base = visual_root.addOrReplaceChild("chest_base", CubeListBuilder.create().texOffs(8, 35).addBox(0.0F, 0.0F, 0.0F, 12.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, -11.0F, 14.0F, 0.0F, 3.1416F, 0.0F));
        ...
        PartDefinition left_paddle = partdefinition.addOrReplaceChild("left_paddle", CubeListBuilder.create().texOffs(56, 35).addBox(-1.0F, 0.0F, -5.0F, 2.0F, 2.0F, 18.0F, new CubeDeformation(0.0F))
                .texOffs(78, 75).addBox(-1.001F, -3.0F, 8.0F, 1.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -4.0F, 9.0F, -0.6409F, 0.6699F, 0.2139F));
        ...
        PartDefinition right_paddle = partdefinition.addOrReplaceChild("right_paddle", CubeListBuilder.create().texOffs(56, 55).addBox(-1.0F, 0.0F, -5.0F, 2.0F, 2.0F, 18.0F, new CubeDeformation(0.0F))
                .texOffs(48, 79).addBox(0.001F, -3.0F, 8.0F, 1.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -4.0F, -9.0F, 2.5007F, 0.6699F, -2.9277F));
        ...
        PartDefinition banner_sail = partdefinition.addOrReplaceChild("banner_sail", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, -17.25F, -2.375F, 2.0F, 57.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(48, 75).addBox(-7.0F, -17.25F, -2.375F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(48, 77).addBox(-7.0F, 7.75F, -2.375F, 14.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.375F, -35.75F, 0.0F, 0.0F, -1.5708F, 0.0F));
